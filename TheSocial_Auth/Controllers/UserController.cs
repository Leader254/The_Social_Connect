...
namespace TheSocial_Auth.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(IUserInterface userService, IConfiguration configuration, IMessageBus imessage, IRabbitMQPublisher rabbitMQPublisher)
        {
        ...
        public async Task<ActionResult<ResponseDto>> RegisterUser(RegisterUserDto registerRequestDto)
        {
            ...
            _rabbitMQPublisher.PublishMessage(message, queueName);
